        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="frm" autocomplete="off" novalidate>
                    <input type="hidden" name="pType" value="setSpecial">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="name" name="name" value="{{ $special->name }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="content" name="content" rows="5">{{ $special->content }}</textarea>
                        </div>
                        <div class="mb-3">
                            <div class="d-flex align-items-center">
                            ...
                            <div class="mb-1 p-2">
                                @include('admin.pages.special.partials.photos', ['files' => $special->files])
                            </div>
                        ...
                        <div class="form-group">
                            <div class="form-check form-switch">
                                <input class="form-check-input ms-auto mt-1" type="checkbox" id="is_active"
                                    name="is_active" @if ($special->is_active) checked @endif>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <button id="submitBtn" type="submit" class="btn btn bg-gradient-warning">특산물 수정</button>
                    </div>
                </form>
            </div>
        </div>

            ...
            <div class="card-body">
                <form id="frm" autocomplete="off" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="pension_name" class="form-control-label">펜션명<span
                                        class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="pension_name" name="pension_name"
                                    placeholder="Enter pension name" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="admin_name" class="form-control-label">관리자 이름<span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="phone" class="form-control-label">펜션 전화번호<span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="email" class="form-control-label">예약시스템 키<span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="password_confirm" class="form-control-label">주소<span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="password" class="form-control-label">상세 주소<span
                                        class="text-danger">*</span></label>

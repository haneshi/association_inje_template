                        ...
                        <thead>
                            <tr>
                                <th
                                    ...
                                    No</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">이미지
                                </th>
                        ...
                        <tbody>
                            @forelse ($dataList as $index => $data)
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            href="{{ route('admin.board.view', ['board_name' => $board->board_name, 'id' => $data->id] + request()->query()) }}">

    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (isset($boards) && $boards->isNotEmpty())
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.board*') ? 'active' : '' }}"
                        data-bs-toggle="collapse" href="#boardCollapse" role="button" aria-expanded="false"
                        aria-controls="boardCollapse">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <x-tabler-book />
                        </div>
                        ...
                        <i class="fas fa-chevron-down ms-auto"
                            style="font-size: 0.75rem; transition: transform 0.3s;"></i>
                    </a>
